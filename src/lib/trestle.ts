...
export const MOCK_LISTINGS: MLSListing[] = [
  {
    ...
    Media: [{ MediaURL: "https://placehold.co/800x500/1A1A1A/C9A84C?text=4821+Birchwood+Ln", Order: 0 }],
    Latitude: 39.7081,
    Longitude: -84.0607,
  },
  {
    ...
    Media: [{ MediaURL: "https://placehold.co/800x500/1A1A1A/C9A84C?text=3107+Maple+Ridge+Dr", Order: 0 }],
  ...
  },
  {
    ...
    Media: [{ MediaURL: "https://placehold.co/800x500/1A1A1A/C9A84C?text=118+Oak+Hill+Ct", Order: 0 }],
    Latitude: 39.6337,
    Longitude: -84.1316,
  },
  {
    ...
    Media: [{ MediaURL: "https://placehold.co/800x500/1A1A1A/C9A84C?text=2255+Valley+View+Rd", Order: 0 }],
  ...
  },
  {
    ...
    Media: [{ MediaURL: "https://placehold.co/800x500/1A1A1A/C9A84C?text=9034+Springhaven+Blvd", Order: 0 }],
    Latitude: 39.5581,
    Longitude: -84.2338,
  },
  {
    ...
    Media: [{ MediaURL: "https://placehold.co/800x500/1A1A1A/C9A84C?text=47+Park+Blvd", Order: 0 }],
    Latitude: 39.7215,
    Longitude: -84.1741,
  },
];
